...
const architecture = [

  {
    ...
    tools: [
      ...
      { name: "APIs", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/graphql/graphql-plain.svg" },
      { name: "Files / Storage", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/googlecloud/googlecloud-original.svg" }
    ]
  },

  {
    ...
    tools: [
      ...
      { name: "Google Pub/Sub", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/googlecloud/googlecloud-original.svg" },
      { name: "Azure Event Hub", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azure/azure-original.svg" }
    ]
  },

  {
    ...
    tools: [
      ...
      { name: "Databricks Auto Loader", logo: "https://www.vectorlogo.zone/logos/databricks/databricks-icon.svg" }
    ]
  },

  {
    ...
    tools: [
      { name: "Apache Spark", logo: "https://www.vectorlogo.zone/logos/apache_spark/apache_spark-icon.svg" },
...

  {
    ...
    tools: [
      ...
      { name: "Microsoft Fabric", logo: "https://cdn.worldvectorlogo.com/logos/microsoft-fabric.svg" }
    ]
  },

  {
    ...
    tools: [
      ...
      { name: "Knowledge Graph (Neo4j)", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/neo4j/neo4j-original.svg" },
      { name: "Vector Database", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pytorch/pytorch-original.svg" }
    ]
  },
...
export default function TechStack() {
  return (
    ...
    >
      ...
      >
        Technologies I use to design modern lakehouse platforms,
        distributed data systems, streaming pipelines, and AI-ready
